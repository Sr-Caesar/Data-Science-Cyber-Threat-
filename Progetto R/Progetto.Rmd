...
zero["Attack"][zero["Attack"] == "Targeted attack"] <- "Unknown"
...
Questa tendenza a trascurare le più semplici contro misure comporta un aumento sempre crescente degli attacchi, si stima che il costo globale del <strong>Crimine Informatico</strong> sia radoppiato negli ultimi 7 anni e ad oggi si aggiri sui 10 trilioni di dollari all'anno (10<sup>18</sup>), gli attacchi effettuati invece si sono quintuplicati negli ultimi 7 anni.</p> <br>
...
probabilmente dovuto al fatto che nel 2020 molte aziende si sono interfacciate con lo <strong>Smart Working</strong>, molte utilizzando metodologie dubbiose o piataforme poco sicure.</p>
...
<p><em>É importante ricordare di come la campagna vaccinale della regione Lazio ha avuto uno stop in concomitanza con l'uscita delle 2°Dosi, per via di  un <strong>trojan cryptolocker</strong>.<br>
...
<li>I dati utilizzati per questa ricerca provengono da un sito il cui proprietario è italiano, quindi avrà avuto accesso a più materiale italiano.<a class="rep" href="https://www.hackmageddon.com/"><strong id=smol><sub>(Hackmageddon)</sub></strong></a></li>
...
Ma non solo, neanche per i paesi più democratici non conviene divulgare certe informazioni, di conseguenza bisogna partire dal presupposto che la maggiorparte degli attacchi di Cyber Warfare sono occultati da attività di <em>Intelligence</em> e prima di una loro divulgazione c'è sicuramente una profonda analisi da parte dei servizi segreti. 
Questo spiega anomalie come quella della <Strong>Nord Corea</strong>.</li>
</ol>
...
<h5>"-The Incredible Rise of North Korea’s Hacking Army"<em style="font-size: small;"><a class="rep" href="https://www.newyorker.com/magazine/2021/04/26/the-incredible-rise-of-north-koreas-hacking-army"><strong>(New Yorker)</strong></a></em></h5>
<p>La Nord Corea è uno dei paesi più attivi dal punto di vista del <strong>Terrorismo Informatico</strong> a tal punto che la stessa <strong>FBI</strong>, <strong>CISA</strong><em style="font-size: small;">(Cybersecurity and Infrastructure Security Agency)</em> ed il <strong>Dipartimento Del Tesoro Degli Stati Uniti</strong> hanno proferito a riguardo, affermando che la Nord Corea è coinvolta in moltissimi attacchi ai danni di infrastrutture sanitarie americane, ed altre società che fanno un utilizzo importante delle <strong>Crypto Currency</strong>.</p>
...
La Nord Corea spesso trafuga delle <strong>Cripto Valute</strong> per bypassare le sanzioni in vigore anche per finanziare gravose spese, come quella militare</p>
<br>
<p>Tuttavia non solo la Nord Corea presenta un pericolo in tal senso, in passato anche il governo <strong>Statunitense</strong> e <strong>Israeliano</strong> sono stati fautori di pericolosissimi attacchi tramite la creazione di minacciosi malware come (<a class="rep" href="https://www.safetysecuritymagazine.com/articoli/stati-e-guerre-senza-confini-geografici/"><strong>Stuntex</strong></a> e <a class="rep" href="https://en.wikipedia.org/wiki/Pegasus_(spyware)"><strong>Pegasus</strong></a>)</p>
...
<span class="flex-container">
<ul id=fst>
<li id=qq><em id=q><strong>Unknown:</strong></em> "Unknown" ovvero metodologia sconosciuta, questo sicuramente è esplicativo di come alcuni attacchi possano essere distruttivi ed allo stesso tempo estremamente occultat.i</li>
<li id=bb><em id=b><strong>POS Malware:</strong></em>Il "<em>Point of Sale</em> Malware è uno script malevolo creato per ottenere le informazioni delle carte di credito, di solito questo attacco viene realizzato tramite molteplici attacchi Mitm.</li>
<li id=tt><em id=t><strong>Account Hijacking:</strong></em>L'account Hijacking è un tipo particolare di <em>furto d'identità</em>, vale a dire processo attraverso il quale è possibile ottenere l'accesso ad un account email o ad un account di un computer, con relativi account associati.</li>
<li id=dd><em id=d><strong>Vulnerability:</strong></em>Le vulnerabilità sono diffetti di fabbrica, le quali vengono sfruttate per compiere degli illeciti, è importate aggiornare spesso dei sistemi poiché ogniqualvolta la casa costruttrice trova una <em>Vulnerabilità</em> la patcha e la rende pubblica, in questo modo molti Hacker hanno avuto metà del lavoro svolto.</li>
<li id=ee><em id=e><strong>Malware:</strong></em>Malware o “software malevolo” è un termine generico che descrive un programma/codice dannoso che mette a rischio un sistema.</li>
</ul>
<ul id=snd>
<li id=ff><em id=f><strong>DDoS:</strong></em>Un attacco DDoS consiste nell'inondare un sito web di richieste in un breve periodo di tempo, con l'obiettivo di travolgere il sito e causarne il crash. Il termine “distribuito” significa che questi attacchi provengono da più luoghi contemporaneamente, rispetto a un DoS che proviene da un solo luogo.</li>
<li id=gg><em id=g><strong>Malicious Code Injection:</strong></em>L'iniezione di codice è lo sfruttamento di un bug del computer causato dall'elaborazione di dati non validi. L'iniezione viene utilizzata da un utente malintenzionato per introdurre codice in un programma per computer vulnerabile e modificare il corso dell'esecuzione.</li>
<li id=hh><em id=h><strong>Defacement:</strong></em>nell'ambito della sicurezza informatica ha solitamente il significato di cambiare illecitamente la home page di un sito web (la sua "<em>faccia</em>") o modificarne, sostituendole, una o più pagine interne.</li>
<li id=ii><em id=i><strong>Bots:</strong></em>Un social bot posta i propri contenuti per lo più tramite account fasulli dotati di una foto profilo, post precedenti e spesso addirittura follower e amici. Attraverso questi account il bot diffonde i suoi messaggi, che siano di marketing o che abbiano finalità politiche.</li>
<li id=ll><em id=l><strong>SQL Injection:</strong></em>Nella sicurezza informatica <strong>SQL</strong> injection è una tecnica di code injection, usata per attaccare applicazioni che gestiscono dati attraverso database relazionali sfruttando il linguaggio SQL. Il mancato controllo dell'input dell'utente permette di inserire artificiosamente delle stringhe di codice SQL che saranno eseguite dall'applicazione server: grazie a questo meccanismo è possibile far eseguire comandi SQL, anche molto complessi, dall'alterazione dei dati (es. creazione di nuovi utenti) al download completo dei contenuti nel database.</li>
</ul>
</span>
</div>
<p></p>
```{r, fig.align='center',echo=FALSE, out.width="70%",fig.width=13, fig.height=13}
...
## Passwords
<br>
<h4 id=end>Concludendo il discorso sui "Semplici Accorgimenti Che Tendono Ad Essere Ignorati", trovo importate citare una particolare forma di attacco,ovvero quella a dizionario.</h4><br>
<hr style="width:50%"><br>
<p id=conclusion>In antitesi con un metodo forza bruta, dove tutte le possibili password sono ricercate in maniera esaustiva, un attacco a dizionario prova solamente quelle ritenute più probabili, tipicamente contenute in una lista . Generalmente, questi attacchi, hanno successo perché la maggior parte delle persone ha la tendenza a scegliere password semplici da ricordare (e quindi semplici da scoprire, ad esempio il proprio nome, quello dei propri figli, date di nascita) e tendenzialmente sceglie parole prese dalla propria lingua nativa.<br><br>
Poiché di solito gli utenti scelgono password facilmente indovinabili, questo attacco ha successo in media 4 volte su 10 quando si utilizza una lista di parole ragionevolmente grande.</p>
<hr style="height:10pt; visibility:hidden;" />
<h3 id=tit>Le 500 Password più utilizzate</h3>
...
wordcloud2(pwd, size=0.3,fontFamily = "Utopia",shape ="circle" , color='random-light', backgroundColor="rgba(1,3,2,255)")

```
<em class="src">Source:</em>
<a class="replink" href="https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-01-14/passwords.csv">GitHub</a>

## Grazie Per L'Attenzione!

<div id=coda>
<ul style="color:hotpink">
  <li><a class="tail" href="https://privacygdpr.it/news-privacy-sanita/sicurezza-informatica-quanto-costano-gli-attacchi-cyber-e-limportanza-di-proteggere-i-sistemi/#:~:text=Si%20stima%20che%20i%20costi,quintuplicati%20dallo%20scoppio%20della%20pandemia.">Costo Degli attacchi informatici all'anno</a></li>
  <li><a class="tail" href="https://www.repubblica.it/tecnologia/sicurezza/2020/04/19/news/videchat_zoom_ancora_sotto_attacco_oltre_500_mila_credenziali_finiscono_sul_dark_web-254477620/">I 500 Mila Account Rubati Di Zoom</a></li>
  <li><a class="tail" href="https://roma.repubblica.it/cronaca/2021/08/01/news/covid_attacco_hacker_al_lazio_disattivati_sistemi_e_portale_della_rete_vaccinale-312554980/">Attacco Hacker Al Lazio</a></li>
  <li><a class="tail" href="https://www.fanpage.it/roma/quanto-hanno-chiesto-di-riscatto-gli-hacker-alla-regione-lazio/">Riscatto Al Lazio</a></li>
  <li><a class="tail" href="newyorker.com/magazine/2021/04/26/the-incredible-rise-of-north-koreas-hacking-army">L'"Armata" Degli Hacker Nord Coreani</a></li>
  <li><a class="tail" href="https://www.tag43.it/indagine-fbi-hacker-nord-corea-furto-criptovalute-sky-mavis-societa-videogiochi/">Furto A Sky Mavis</a></li>
  <li><a class="tail" href="https://techcrunch.com/2022/07/06/fbi-north-korea-targeting-healthcare/?guccounter=1&guce_referrer=aHR0cHM6Ly93d3cuZ29vZ2xlLmNvbS8&guce_referrer_sig=AQAAAFWDQ_r6r0j2VH1HRZy_NLj_Fc5dFIOTiStWj0u7jsJQFkWvuUs_LYE2IC1hYGr0j21JqK9TV7_BATQBQN-wbIbIaJ65x6wXYbLNEHvDASG5T4JJ3-DXHOLIYuDL1mU1wc5JqSZXnwBaezeKBBYG1hp-2wu59BCH1dI3lR6ilA7r">Sanità Americana Sotto Attacco Dalla Nord Corea</a></li>
  <li><a class="tail" href="https://www.repubblica.it/esteri/2022/02/06/news/corea_del_nord_arsenale_nucleare_rapporto_onu-336693992/">Finanziamento Nucleare Nord Coreano Tramite Le Cripto</a></li>
  <li><a class="tail" href="https://www.wired.it/internet/web/2018/05/30/corea-nord-hacking/">Chi Sono Gli Hacker Nord Coreani</a></li>
  <li><a class="tail" href="https://www.hackmageddon.com/">Datasets 2018,2020,2021</a></li>
  <li><a class="tail" href="https://www.safetysecuritymagazine.com/articoli/stati-e-guerre-senza-confini-geografici/">Stuntex Malware</a></li>
  <li><a class="tail" href="https://en.wikipedia.org/wiki/Pegasus_(spyware)">Pegasus Malware</a></li>
  <li><a class="tail" href="https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-01-14/passwords.csv">Top 500 
</ul>  
</div>